    ...
    <Box component="form" onSubmit={handleSubmit(onSubmit)} sx={{ mt: 3 }}>
      ...
      <FormControl component="fieldset" margin="normal">
        ...
        <RadioGroup row aria-label="gender">
          <FormControlLabel value="Male" control={<Radio />} label="Male"    {...register("gender", { required: "Gender is required" })} />
          <FormControlLabel value="Female" control={<Radio />} label="Female"    {...register("gender", { required: "Gender is required" })} />
        </RadioGroup>
        {errors.gender && (
